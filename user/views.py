...
def search(request):  # 搜索
    ...
    return render(request, "user/items.html", {"movies": movies, 'title': '搜索结果'})
...
def hot_movie(request):
    ...
    return render(request, "user/items.html", {"movies": movies, "title": "收藏最多"})
...
def most_mark(request):
    ...
    return render(request, "user/items.html", {"movies": movies, "title": "评分最多"})
...
def most_view(request):
    ...
    movies = movies_paginator(movies, page_number)
    return render(request, "user/items.html", {"movies": movies, "title": "浏览最多"})
...
def director_movie(request, director_name):
    ...
    movies = movies_paginator(movies, page_number)
    return render(request, "user/items.html", {"movies": movies, "title": "{}的电影".format(director_name)})
