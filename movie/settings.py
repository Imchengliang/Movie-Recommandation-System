...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'movie1.colaplusice.com']
...
# MEDIA_URL = 'http://movie1.colaplusice.com/media/'
...
if ENV_PROFILE == 'production':
    # cdn地址
    STATIC_URL = "http://static.colaplusice.com/movie1/static/"
    # nginx配置的文件目录
    STATIC_ROOT = "/www/movie1/static"
